#!/usr/bin/env python3
"""
Comprehensive LTMC Tool Validation Suite
Tests ALL 28 LTMC tools for functionality and data persistence.

Tool Categories:
- Memory (2): store_memory, retrieve_memory
- Chat (4): log_chat, ask_with_context, route_query, get_chats_by_tool  
- Todo (4): add_todo, list_todos, complete_todo, search_todos
- Context (6): build_context, retrieve_by_type, store_context_links, get_context_links_for_message, get_messages_for_chunk, get_context_usage_statistics
- Graph (4): link_resources, query_graph, auto_link_documents, get_document_relationships
- Meta (2): list_tool_identifiers, get_tool_conversations
- Code Pattern (3): log_code_attempt, get_code_patterns, analyze_code_patterns
- Redis (3): redis_cache_stats, redis_flush_cache, redis_health_check
"""
...
class LTMCToolTester:
    """Comprehensive tester for all 28 LTMC tools"""
    ...
    def test_graph_tools(self) -> Dict[str, Any]:
        ...
        # Test 4: get_document_relationships
    ...
    def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        print(f"Starting comprehensive LTMC tool validation at {datetime.now().isoformat()}")
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        print("\n" + "="*80)
        print("COMPREHENSIVE LTMC TOOL VALIDATION REPORT")
        print("="*80)
...
def main():
    ...
    print("LTMC Comprehensive Tool Validation Suite")
    print("Testing ALL 28 tools for functionality and persistence")
    print("="*80)
    ...
    tester = LTMCToolTester()
    report = tester.run_comprehensive_test()
    
    # Save report to file
    report_filename = f"ltmc_validation_report_{int(time.time())}.json"
